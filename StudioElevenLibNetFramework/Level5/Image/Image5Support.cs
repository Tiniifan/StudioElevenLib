...
using StudioElevenLib.Common.Imaging.PixelFormats;

namespace StudioElevenLib.Level5.Image
{
    public static class Image5Support
    {
        ...
        public static Dictionary<byte, IPixelFormat> ImgcPixelFormats = new Dictionary<byte, IPixelFormat>
        {
            {0x00, new RGBA8888() }, 
            {0x01, new RGBA4444() }, 
            {0x02, new RGBA5551() },
        ...
        public static Dictionary<byte, IPixelFormat> ImgnPixelFormats = new Dictionary<byte, IPixelFormat>
        {
            {0x00, new ABGR8888() }, 
            {0x03, new RGB888() },   
            {0x0E, new A8() },
